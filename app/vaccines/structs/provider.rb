module Vaccines
  module Structs
    class Provider
      attr_reader :name, :address1, :address2, :city, :state, :zipcode, :phone,
      ...
      def initialize(name: nil, address1: nil, address2: nil, city: nil, state: nil, zipcode: nil, phone: nil,
                     distance: nil, lat: nil, long: nil,
